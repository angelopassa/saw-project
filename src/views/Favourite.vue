<template>
    <div class="flex container mx-auto justify-center">
        ...
        <div v-if="noNet" class="flex flex-col bg-red-400 rounded-xl text-white font-bold p-5 justify-center items-center">
        ...
        <span v-else-if="fav == null && !loading" class="text-sm">Non hai ancora aggiunto nessun film o
            serie ai
            preferiti</span>
        ...
        <div v-else class="w-full">
            <div class="hidden md:block">
                <table class="w-full text-sm text-left text-indigo-500 rounded-lg shadow-md">
                    ...
                    <tbody>
                        <tr v-for="(item, index) in fav" class="bg-white border-b hover:bg-gray-50">
                            <td class="p-4 w-40">
