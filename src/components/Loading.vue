<template>
    <div role="status" class="space-y-8 animate-pulse md:space-y-0 md:space-x-8 md:flex">
        ...
        <div class="w-full">
            <div class="h-5 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[300px] mb-4"></div>
            ...
            <div class="h-2.5 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[360px]"></div>
            <div class="h-2 bg-gray-200 rounded-full dark:bg-gray-700 max-w-[300px] mt-5 mb-2.5"></div>
